...
export default function ProductCard({ prod }) {
	...
	return (
		<>
			<div className='card h-100 position-relative d-flex flex-column'>
				{isAuthenticated && (
				...
				<img src={prod.image.url} alt={prod.image.alt} className='card-img-top' style={{ objectFit: "cover", height: "120px", width: "100%" }} />
